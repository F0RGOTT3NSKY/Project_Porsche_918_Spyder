...
def Ventana_about():
    ...
    base=Canvas(about,bg="black",width=1200,height=800).pack()
    label1=Label(base,image=fondo).place(x=10,y=20)
...
drive = Button(root, text="TEST DRIVE",width=18,font=("Comic Sans MS",10),command= lambda:TestDrive,justify=CENTER,bg="#800000",fg="white",relief="raised",bd=15)
